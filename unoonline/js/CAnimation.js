function CAnimation (){
    ...
    this.drawFourAnim = function (iIndexPlayer,iNumberOfCards,iDelay,iDrawType){
        ...
        new createjs.Tween.get(_oDrawFour).to({alpha: 1, scaleX: 1.4, scaleY: 1.4},200, createjs.Ease.cubicOut).wait(200).call(function(){
    ...
    this.drawTwoAnim = function (iIndexPlayer,iNumberOfCards,iDelay,iDrawType){
        ...
        new createjs.Tween.get(_oDrawTwo).to({alpha: 1, scaleX: 1.4, scaleY: 1.4},200, createjs.Ease.cubicOut).wait(200).call(function(){
    ...
    this.stopTurn = function (){
        return  new Promise(function(resolve, reject){
            ...
            new createjs.Tween.get(_oStopTurn).to({alpha: 1, scaleX: 2, scaleY: 2},200, createjs.Ease.cubicOut)
                    .to({scaleX: 1.6, scaleY: 1.6},200)
                    .to({scaleX: 2, scaleY: 2},200)
                    .to({scaleX: 1.6, scaleY: 1.6},200).to({scaleX: 2, scaleY: 2},200)
    ...
    this.changeClockWise = function(bClockWise){
        ...
        return  new Promise(function(resolve, reject){
            ...
            if (bClockWise===false){
                new createjs.Tween.get(_oChangeClockWise).to({alpha: 1, scaleX: 2, scaleY: 2},200, createjs.Ease.cubicOut)
    ...
    this.endAnimation = function(evt, resolve){
        if (_bColor === true){
            ...
            new createjs.Tween.get(_oChangeColor).to({scaleX: 2, scaleY: 2},250).to({scaleX: 1.4, scaleY: 1.4},250)
                    .to({scaleX: 2, scaleY: 2},250).to({scaleX: 1.4, scaleY: 1.4},250)
                    .to({alpha: 0, scaleX: 0.1, scaleY: 0.1},200, createjs.Ease.cubicIn).call(function(){ 
