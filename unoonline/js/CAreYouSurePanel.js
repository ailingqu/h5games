function CAreYouSurePanel(oFunction) {
    ...
    this._init = function (oFunction) {
        ...
        new createjs.Tween.get(_oPanelContainer).to({y:CANVAS_HEIGHT/2 - iPY},500, createjs.Ease.quartIn).call(function(){/*createjs.Ticker.paused = true;*/});
        ...
        //s_oCrazyApiManager.showMediumBanner();
    };
