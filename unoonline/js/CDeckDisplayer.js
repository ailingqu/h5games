function CDeckDisplayer (iX,iY,oParentContainer,bHelpAnim){
    ...
    this.initializeDeck = function(){
        ...
        for (var i=0;i<4;i++){
            for (var j=0;j<10;j++){
                ...
                _aCards.push(new CCard(0,0,_oContainer,szFotogram,iRank,i,_iUniqueID++,0));
            }
        }
        for (var i=0;i<4;i++){
            for (var j=0;j<9;j++){
                ...
                _aCards.push(new CCard(0,0,_oContainer,szFotogram,iTmpSum,i,_iUniqueID++,0));
            }
        }
        for (var i=0;i<4;i++){
            for (var j=0;j<2;j++){
                ...
                */
                ...
                _aCards.push(new CCard(0,0,_oContainer,i*13+10,10,i,_iUniqueID++,0));
                _aCards.push(new CCard(0,0,_oContainer,i*13+11,11,i,_iUniqueID++,0));
                _aCards.push(new CCard(0,0,_oContainer,i*13+12,12,i,_iUniqueID++,0));
            }
        }
        for (var i=0;i<4;i++){
            _aCards.push(new CCard(0,0,_oContainer,FOTOGRAM_COLOR,13,4,_iUniqueID++,0));
            _aCards.push(new CCard(0,0,_oContainer,FOTOGRAM_DRAW_FOUR,14,4,_iUniqueID++,0));
        }
    };
    ...
    this.initializeFromData = function(oData){
        ...
        for(var i=0; i<oData.length; i++){
            ...
            _aCards.push(new CCard(0,0,_oContainer,oData[i],iRank,iSuit,_iUniqueID++,0));
        }
    };
    ...
    this.setCardToBottom = function(oCard){
        oCard.setVisible(false);
        _aCards.unshift(oCard);
    };
    ...
    this.setChildDepth = function(iIndex){
        ...
        s_oStage.setChildIndex(_oContainer,iIndex); 
    };
