(() => {
  ...
  const r = new (class {
    #e = [];
    enqueue(e, o, i, r) {
      const a = { fn: e, args: o || [], resolveFn: i, rejectFn: r };
  ...
  if (
    ...
    try {
      ...
      const o = e("game_id"),
        ...
        a = (e) => /^[-+]?\d+$/.test(e.trim()),
        n = (e, t, o) =>
          ("game" === e && "loading" === t && "start" === o) ||
          ("game" === e && "loading" === t && "complete" === o) ||
          ("game" === e && "launch" === t && "" === o) ||
          ("game" === e && "meaningful" === t && "first" === o) ||
          ("tutorial" === e && "start" === t && "" === o) ||
          ("tutorial" === e && "complete" === t && "" === o) ||
          !("progress" !== e || "start" !== t || !a(o)) ||
          !("progress" !== e || "complete" !== t || !a(o)) ||
          !("progress" !== e || "fail" !== t || !a(o)) ||
          ("rewarded" === e && "visible" === t) ||
          ("rewarded" === e && "click" === t) ||
          !("rewarded" !== e || "start" !== t || !a(o)) ||
          !("rewarded" !== e || "complete" !== t || !a(o)) ||
          !("midroll" !== e || "start" !== t || !a(o)) ||
          !("midroll" !== e || "complete" !== t || !a(o)) ||
          "custom" === e;
      (window.PokiSDK.measure = (e, a, s) => {
        "level" === (e = `${e}`) && (e = "progress"),
          n(
            e,
            (a = void 0 === a ? "" : `${a}`),
            (s = void 0 === s ? "" : `${s}`)
              ...
              window.parent.postMessage(
                {
                  ...
                  content: {
                    ...
                    data: { category: e, action: a, label: s },
                  },
                },
                "*"
              ),
            ...
            : console.warn(
                `%cPOKI:%c measure() event not allowed: ${e}-${a}-${s}`,
                "font-weight: bold",
                ""
              );
      }),
  ...
  const a = (() => {
    ...
    //     e("ab") ||
    //     "5ca7710b4e089af65cb8f6c747d472b76ec8592f";
    //   let a = `poki-sdk-core-${r}.js`;
    //   t && (a = `poki-sdk-kids-${r}.js`),
    //     o && (a = `poki-sdk-playground-${r}.js`),
    //     i && (a = `poki-sdk-hoist-${r}.js`);
    //   new URL(document.currentScript.src);
      return `poki-sdk-core-5ca7710b4e089af65cb8f6c747d472b76ec8592f.js`;
    })(),
