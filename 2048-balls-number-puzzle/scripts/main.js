  ...
  });
{
  ...
  window.DOMElementHandler = class extends self.DOMHandler {
    ...
    _OnCreate(t) {
      ...
      o.addEventListener("focus", (e) => this._OnFocus(i)),
        o.addEventListener("blur", (e) => this._OnBlur(i));
      const a = t.htmlIndex;
      if (
        (n.SetWantHTMLIndex(a), n.SetHTMLZIndex(t.htmlZIndex), this._autoAttach)
      ) {
    ...
    _OnUpdatePosition(e) {
      ...
      a !== t.GetActualHTMLIndex() &&
        (i.remove(),
        s.GetHTMLWrapElement(a).appendChild(i),
      ...
      r !== t.GetHTMLZIndex() &&
        ...
        t.HadFirstUpdate() ||
          (t.SetHadFirstUpdate(), t.GetVisibleFlag() && (i.style.display = ""));
    }
...
{
  const t = /(iphone|ipod|ipad|macos|macintosh|mac os x)/i.test(
      navigator.userAgent
    ),
  ...
  window.RuntimeInterface = class e {
    constructor(e) {
      if (
        ...
        ("playable-ad-single-file" !== this._exportType &&
          ...
          (this._useWorker = !1),
        s && (this._useWorker = !1),
        "cordova" === this._exportType && this._useWorker && i)
      ) {
    ...
    *_CanDoAndroidVirtualKeyboardDetection() {
    ...
    async _Init(e) {
      if (
        (this._useWorker && ((await a()) || (this._useWorker = !1)),
        "macos-wkwebview" === this._exportType &&
    ...
    _OnUpdateCanvasSize(e) {
      ...
      const t = e.styleWidth + "px",
        ...
        s = e.marginLeft + "px",
        n = e.marginTop + "px";
      for (const { canvas: e, htmlWrap: o } of this._canvasLayers)
        (e.style.width = t),
          (e.style.height = i),
          ...
          this._isFirstSizeUpdate &&
            ((e.style.display = ""), (o.style.display = ""));
    ...
    _OnSetHTMLLayerCount(e) {
      ...
      return (
        this._UpdateHTMLElementsZOrder(), { addedCanvases: d, transferables: l }
      );
    }
    _UpdateHTMLLayerDOMProperties(e) {
      for (
        let t = 0, i = Math.min(this._canvasLayers.length, e.length);
        t < i;
        ++t
      ) {
        const { htmlWrap: i, lastHtmlLayerDomState: s } = this._canvasLayers[t],
          n = e[t],
          o = n.isVisible,
          a = n.opacity,
          r = n.isInteractive;
        o !== s.isVisible &&
          ((i.style.display = o ? "" : "none"), (s.isVisible = o)),
          a !== s.opacity &&
            ((i.style.opacity = 1 === a ? "" : String(a)), (s.opacity = a)),
          r !== s.isInteractive &&
            ((i.style.pointerEvents = r ? "" : "none"),
            r
              ? i.setAttribute("interactive", "")
              : i.removeAttribute("interactive"),
            (s.isInteractive = r));
      }
    }
    ...
    AddRuntimeComponentMessageHandler(e, t, i) {
      let s = p.get(e);
      if ((s || ((s = new Map()), p.set(e, s)), s.has(t)))
    ...
    _OnWrapperMessage(t, i) {
      ...
      if ("directory-handles" === s) this._directoryHandles = i;
        ...
        this._wrapperInitResolve(t), (this._wrapperInitResolve = null);
        ...
        "extension-message" === s
          ...
          : console.warn("Unknown wrapper message: ", t);
    }
    ...
    _SendWrapperMessage(e) {
      this.IsAnyWebView2Wrapper()
        ...
        : "macos-wkwebview" === this._exportType
        ? window.webkit.messageHandlers.C3Wrapper.postMessage(JSON.stringify(e))
        : "linux-cef" === this._exportType &&
...
}
{
  ...
  const C = new Map([
    ...
    R = { dispatchRuntimeEvent: !0, dispatchUserScriptEvent: !0 },
    T = { dispatchUserScriptEvent: !0 },
  ...
  const E = new Set(["input", "textarea", "datalist", "select"]),
  ...
  const D = "runtime",
    H = class extends self.DOMHandler {
      constructor(e) {
        super(e, D),
        ...
        if (
          (window.addEventListener("contextmenu", (e) => {
            ...
            t.has(s) || k(i) || e.preventDefault();
          }),
          window.addEventListener("selectstart", I),
          window.addEventListener("gesturehold", I),
          window.addEventListener("touchstart", I, { passive: !1 }),
          window.addEventListener("pointerdown", I, { passive: !1 }),
          (this._mousePointerLastButtons = 0),
          window.addEventListener("mousedown", (e) => {
            1 === e.button && e.preventDefault();
          }),
          window.addEventListener("mousewheel", x, { passive: !1 }),
          window.addEventListener("wheel", x, { passive: !1 }),
      ...
      _AddDefaultCanvasEventHandlers(e) {
        e.addEventListener("selectstart", I),
          e.addEventListener("gesturehold", I),
          e.addEventListener("pointerdown", I);
      }
      _AddDefaultHTMLWrapEventHandlers(e) {
        e.addEventListener("selectstart", L),
          e.addEventListener("gesturehold", L),
      ...
      Attach() {
        window.addEventListener("focus", () =>
          ...
          window.addEventListener("focusin", (e) => {
            var t;
            (t = e.target),
              (E.has(t.tagName.toLowerCase()) || k(t)) &&
          ...
          window.addEventListener("mousedown", (e) =>
            this._OnMouseEvent("mousedown", e, T)
          ),
          window.addEventListener("mousemove", (e) =>
            this._OnMouseEvent("mousemove", e, T)
          ),
          window.addEventListener("mouseup", (e) =>
            this._OnMouseEvent("mouseup", e, T)
          ),
          window.addEventListener("dblclick", (e) =>
            this._OnMouseEvent("dblclick", e, R)
          ),
          window.addEventListener("wheel", (e) =>
            this._OnMouseWheelEvent("wheel", e, R)
          ),
      ...
      _OnFullscreenChange() {
        if (this._isExportToVideo) return;
        const e = S.IsDocumentFullscreen();
        e &&
      ...
      _OnDeviceMotion(e) {
        ...
        n && (s = { x: n.x || 0, y: n.y || 0, z: n.z || 0 });
        let o = null;
        const a = e.rotationRate;
        a &&
          (o = { alpha: a.alpha || 0, beta: a.beta || 0, gamma: a.gamma || 0 }),
          this.PostToRuntime(
            "devicemotion",
            {
              acceleration: t,
      ...
      _OnScriptCreateWorker(e) {
        ...
        new Worker(t, i).postMessage(
          { type: "construct-worker-init", port2: s },
          [s]
        );
      }
      _OnAlert(e) {
  ...
  self.JobSchedulerDOM = class {
    ...
    async _CreateJobWorker() {
      const e = this._jobWorkers.length,
        t = this._runtimeInterface.GetScriptFolder() + W,
...
}
{
  ...
  window.addEventListener(
    "beforeinstallprompt",
    (e) => (e.preventDefault(), (U = e), B && B._OnBeforeInstallPrompt(), !1)
  );
  const z = "browser",
    j = class extends self.DOMHandler {
      ...
      Attach() {
        U ? this._OnBeforeInstallPrompt() : (B = this),
      ...
      async _OnRequestInstall() {
        if (!U) return { result: "unavailable" };
        try {
          return U.prompt(), { result: (await U.userChoice).outcome };
        } catch (e) {
          return (
      ...
      _OnExitFullscreen() {
        if (
          ...
          document.exitFullscreen
            ...
            e instanceof Promise && e.catch(q);
        }
      }
      _OnSetHash(e) {
...
}
{
  ...
  self.RuntimeInterface.AddDOMHandlerClass(K);
}
{
  ...
  (self.AudioDOMHandler = class extends self.DOMHandler {
    ...
    async _CreateAudioContext(e) {
      if (
        ...
        (this._audioContext = new AudioContext({ latencyHint: e.latencyHint })),
    ...
    *audioInstancesByEffectTag(e) {
    ...
    async _GetAudioBuffer(e, t, i, s, n) {
      for (const e of this._audioBuffers)
        if (e.GetUrl() === t)
          return (
            s && this._playMusicAsSound && (this._lastMusicBuffer = e),
            await e.Load(),
            e
          );
      if (n) return null;
      ...
      return (
        ...
        s && this._playMusicAsSound && (this._lastMusicBuffer = o),
        await o.Load(),
        ...
        if (e.GetUrl() === t && (e.CanBeRecycled() || n))
          return (
            n &&
              ...
              (this._lastMusicBuffer = e.GetBuffer()),
            e.SetTags(s),
            e
          );
    ...
    _SetStereoPan(e) {
      const t = e.tags,
        i = e.p;
      for (const e of this.audioInstancesMatchingTags(t))
        e.SetStereoPannerEnabled(!0), e.SetStereoPan(i);
    }
    async _FadeVolume(e) {
      const t = e.tags,
        i = e.vol,
    ...
    async _AddEffect(e) {
      ...
      for (const a of i) {
        if ("filter" === t) n = new self.C3AudioFilterFX(this, ...s);
          ...
          (n = new self.C3AudioConvolveFX(this, o.GetAudioBuffer(), ...s)),
...
(self.C3AudioBuffer = class {
  ...
  static Create(e, t, i, s, n) {
    return !n || e.IsPlayMusicAsSound()
      ? new self.C3WebAudioBuffer(e, t, i, s, n)
  ...
  });
{
  ...
  (self.C3AudioFilterFX = class extends ee {
    ...
    (self.C3AudioDelayFX = class extends ee {
      constructor(e, t, i, s) {
        super(e),
          (this._type = "delay"),
          (this._params = [t, i, s]),
    ...
    (self.C3AudioConvolveFX = class extends ee {
      constructor(e, t, i, s) {
        super(e),
    ...
    (self.C3AudioFlangerFX = class extends ee {
    ...
    (self.C3AudioPhaserFX = class extends ee {
      constructor(e, t, i, s, n, o, a) {
        super(e),
          (this._type = "phaser"),
          (this._params = [t, i, s, n, o, a]),
    ...
    (self.C3AudioGainFX = class extends ee {
      constructor(e, t) {
        super(e),
          (this._type = "gain"),
          (this._params = [t]),
    ...
    (self.C3AudioStereoPanFX = class extends ee {
      constructor(e, t) {
        super(e),
    ...
    (self.C3AudioTremoloFX = class extends ee {
      constructor(e, t, i) {
        super(e),
          (this._type = "tremolo"),
          (this._params = [t, i]),
    ...
    (self.C3AudioRingModFX = class extends ee {
      constructor(e, t, i) {
        super(e),
          (this._type = "ringmod"),
          (this._params = [t, i]),
    ...
    (self.C3AudioDistortionFX = class extends ee {
      constructor(e, t, i, s, n, o) {
        super(e),
    ...
    (self.C3AudioCompressorFX = class extends ee {
      constructor(e, t, i, s, n, o) {
        super(e),
    ...
    (self.C3AudioAnalyserFX = class extends ee {
      constructor(e, t, i) {
        super(e),
          (this._type = "analyser"),
          (this._params = [t, i]),
...
{
  const te = "keyboard",
    ie = class extends self.DOMHandler {
      constructor(e) {
        super(e, te),
        ...
        try {
          return (
            0 === t.length
              ...
              : await navigator.keyboard.lock(t),
            { isOk: !0 }
          );
        } catch (e) {
          return console.error("Error locking keyboard:", e), { isOk: !1 };
        }
      }
      _OnUnlockKeyboard() {
        try {
  ...
  self.RuntimeInterface.AddDOMHandlerClass(ie);
}
{
  const se = "platform-info";
  function ne(e) {
    return new Promise((t, i) => {
      e.getInsetTop(t, i);
    });
  ...
  const de = class extends self.DOMHandler {
    constructor(e) {
      super(e, se),
        this.AddRuntimeMessageHandlers([
    ...
    async _GetSafeAreaInset() {
      ...
      try {
        return await Promise.all([ne(e), oe(e), ae(e), re(e)]);
      } catch (e) {
        return (
          console.error(
...
}
{
  ...
  const ce = class extends self.DOMElementHandler {
    constructor(e) {
      super(e, le);
    }
    CreateElement(e, t) {
      ...
      return (
        ...
        n.addEventListener("pointerdown", he),
        n.addEventListener("pointerrawupdate", he),
        n.addEventListener("pointerup", he),
        n.addEventListener("mousedown", he),
        n.addEventListener("mouseup", he),
        n.addEventListener("keydown", he),
        n.addEventListener("keyup", he),
  ...
  self.RuntimeInterface.AddDOMHandlerClass(ce);
}
