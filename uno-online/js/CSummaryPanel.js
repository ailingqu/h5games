function CSummaryPanel(oParentContainer){
    ...
    this._init = function(){
        ...
        //_oButHome.setLabel(40, -10, TEXT_LABEL_HOME, 40, 150, 80);
        ...
        */
        ...
        //_oButNext.setLabel(40, -10, TEXT_LABEL_NEXT, 40, 150, 80);
    ...
    this.setAndShow = function(aData, iWinnerIndex, iMatchScore){
        ...
        createjs.Tween.get(_oFade).to({alpha:0.7},500).call(function(){
            ...
            _oFade.on("mousedown",_oParent._onShow,_oParent);
        });
        createjs.Tween.get(_oGroup).to({alpha:1 }, 500);
        
        //s_oCrazyApiManager.showLeaderboardBanner();
    };
    ...
    this.reset = function(){
        ...
        //_oButNext.changeLabelText(TEXT_LABEL_NEXT);
    ...
    this.show = function(){
        ...
        _oFade.alpha = 0.7;
        _oFade.removeAllEventListeners();
        _oFade.on("mousedown",this._onShow,this);
    };
    ...
    this.endMode = function(szText){
        ...
        _oButNext.setImage(oSprite);
        //_oButNext.changeLabelText(TEXT_LABEL_NEWMATCH);
